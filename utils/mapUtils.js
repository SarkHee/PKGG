...
const MAP_INFO = {
  ...
  // TDM / 이벤트 전용 맵
  Italy_TDM_Main:       { name: '이탈리아 TDM',   img: '/maps/erangel.jpg' },
  Tiger_TDM_Main:       { name: '태이고 TDM',     img: '/maps/taego.jpg' },
  Baltic_TDM_Main:      { name: '에란겔 TDM',     img: '/maps/erangel.jpg' },
  Boardwalk_Main:       { name: '보드워크 TDM',   img: '/maps/erangel.jpg' },
  PillarCompound_Main:  { name: '필라 컴파운드',  img: '/maps/erangel.jpg' },
  // 이미 변환된 영문명 (하위 호환)
