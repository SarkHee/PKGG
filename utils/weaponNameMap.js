// utils/weaponNameMap.js — pubg/api-assets 자동 생성
...
const weaponNameMap = {
  ...
  // ── 차량 (BP_ 접두사) ──────────────────────────────────────────────────────
  // 오토바이
  'BP_Motorbike_04_C':                '오토바이',
  'BP_Motorbike_04_Desert_C':         '오토바이',
  'BP_Motorbike_04_v2_C':             '오토바이',
  'BP_Motorbike_Sidecar_04_C':        '사이드카 오토바이',
  'BP_Motorbike_Sidecar_04_Desert_C': '사이드카 오토바이',
  'BP_Motorbike_Sidecar_04_v2_C':     '사이드카 오토바이',
  // 지상 차량
  'BP_Pickup_01_C':                   '픽업트럭',
  'BP_Pickup_01_Desert_C':            '픽업트럭',
  'BP_Pickup_01_v2_C':                '픽업트럭',
  'BP_UAZ_01_C':                      'UAZ',
  'BP_UAZ_01_Desert_C':               'UAZ',
  'BP_UAZ_01_v2_C':                   'UAZ',
  'BP_UAZ_Open_01_C':                 'UAZ (오픈)',
  'BP_UAZ_Open_01_Desert_C':          'UAZ (오픈)',
  'BP_Dacia_01_C':                    '다시아',
  'BP_Dacia_01_Desert_C':             '다시아',
  'BP_Dacia_01_v2_C':                 '다시아',
  'BP_Buggy_01_C':                    '버기',
  'BP_Buggy_01_Desert_C':             '버기',
  'BP_Buggy_01_v2_C':                 '버기',
  'BP_Mirado_01_C':                   '미라도',
  'BP_Mirado_Open_01_C':              '미라도 (오픈)',
  'BP_Mirado_01_v2_C':                '미라도',
  'BP_Rony_01_C':                     '로니',
  'BP_Rony_01_Desert_C':              '로니',
  'BP_Rony_01_v2_C':                  '로니',
  'BP_Coupe_RB_C':                    '쿠페 RB',
  'BP_V8_C':                          'V8쿠페',
  'BP_Van_01_C':                      '밴',
  'BP_Van_01_Damaged_C':              '밴',
  'BP_LadderTruck_01_C':              '소방차',
  'BP_LadderTruck_01_Damaged_C':      '소방차',
  'BP_MedVehicle_01_C':               '앰뷸런스',
  'BP_MedVehicle_01_Damaged_C':       '앰뷸런스',
  'BP_KartP_01_C':                    '레이싱 카트',
  'BP_Jeep_01_C':                     '지프',
  'BP_Tukshai_01_C':                  '툭샤이',
  'BP_Zima_01_C':                     '지마',
  'BP_3Wheeled_Cycle_C':              '세발 자전거',
  'BP_Bicycle_C':                     '자전거',
  'BP_Scooter_C':                     '전동킥보드',
  'BP_Military_E_Bike_C':             '전기 바이크',
  'BP_Porter_01_C':                   '포터',
  'BP_TransAm_00_C':                  '트랜스엠',
  // 설상 차량
  'BP_Snowmobile_C':                  '스노우모빌',
  'BP_Snowmobile_SL_C':               '스노우모빌 SL',
  'BP_Snowbike_C':                    '스노우 바이크',
  // 수상 차량
  'BP_AquaRail_01_C':                 '아쿠아레일',
  'BP_AquaRail_01_Desert_C':          '아쿠아레일',
  'BP_Boat_01_C':                     '모터보트',
  'BP_Boat_PG117_C':                  'PG-117',
  'BP_PG117_C':                       'PG-117',
  // 특수 차량
  'BP_AntiAircraftGun_01_C':          '대공포',
  'BP_Helicopter_01_C':               '헬기',
  'BP_BRDM_01_C':                     'BRDM-2',
}

export default weaponNameMap
