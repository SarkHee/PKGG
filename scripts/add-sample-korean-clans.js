...
const sampleKoreanClans = [
  {
    ...
    isKorean: true,
    members: [
      { nickname: '김치전사1', score: 2500, style: '공격형', avgDamage: 450.5, avgKills: 3.2 },
      { nickname: '김치전사2', score: 2300, style: '생존형', avgDamage: 380.2, avgKills: 2.8 },
      { nickname: '한국짱', score: 2700, style: '저격형', avgDamage: 520.0, avgKills: 3.8 },
      { nickname: '서울특별시', score: 2100, style: '지원형', avgDamage: 340.1, avgKills: 2.1 }
    ]
  },
  {
    name: 'Seoul Eagles',
    ...
    isKorean: true,
    members: [
      { nickname: '서울독수리', score: 2800, style: '공격형', avgDamage: 480.3, avgKills: 3.5 },
      { nickname: '한강에서만났어', score: 2600, style: '생존형', avgDamage: 420.7, avgKills: 3.0 },
      { nickname: '경복궁가드', score: 2900, style: '저격형', avgDamage: 550.2, avgKills: 4.1 }
    ]
  },
  {
    name: 'Team Korea Pro',
    ...
    isKorean: true,
    members: [
      { nickname: '프로게이머A', score: 3200, style: '극단적 공격형', avgDamage: 650.0, avgKills: 4.8 },
      { nickname: '프로게이머B', score: 3100, style: '지속 전투형', avgDamage: 620.5, avgKills: 4.5 },
      { nickname: '태극기전사', score: 3000, style: '치명적 저격수', avgDamage: 590.3, avgKills: 4.2 }
    ]
  },
  {
    name: 'Dragon Force',
    ...
    isKorean: false,
    members: [
      { nickname: '龙战士', score: 2750, style: '공격형', avgDamage: 470.0, avgKills: 3.4 },
      { nickname: '北京狙击手', score: 2650, style: '저격형', avgDamage: 510.5, avgKills: 3.7 }
    ]
  }
];
...
async function addSampleClans() {
  ...
  try {
    for (const [index, clanData] of sampleKoreanClans.entries()) {
      console.log(`🎯 [${index + 1}/${sampleKoreanClans.length}] ${clanData.name} 추가 중...`);
      ...
      const clan = await prisma.clan.create({
        data: {
          ...
          avgScore: Math.round(clanData.members.reduce((sum, m) => sum + m.score, 0) / clanData.members.length),
