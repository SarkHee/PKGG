...
const sections = [
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul className="list-disc list-inside space-y-1.5 text-gray-600 dark:text-gray-400 mb-3">
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-gray-600 dark:text-gray-400 mb-3">포럼에 게시글 및 댓글 작성 시 아래 규칙을 준수해야 합니다.</p>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-3 bg-gray-50 dark:bg-gray-800 rounded-lg px-4 py-2 border border-gray-200 dark:border-gray-700">
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
        ...
        <div className="max-w-3xl mx-auto px-4 py-8 space-y-6">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-800 p-6">
            <h2 className="text-base font-bold text-gray-900 dark:text-gray-100 mb-3">문의</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-2">약관 관련 문의는 아래 이메일로 연락 바랍니다.</p>
            <a
