...
// ── 총기 데이터 (Recoil Comparison #29 이미지 기반 업데이트) ─────────────
const WEAPONS = [
  // ─── AR (돌격소총) ───────────────────────────────────────────────────────
  {
    id: 'ACE32', name: 'ACE32', cal: '7.62mm', rpm: 698, dmg: 44, rounds: 30,
    color: '#14B8A6',
    pullDown: '많이', pullH: '좌 (약간)',
    desc: '안정적인 7.62mm AR. 초반 좌편향 후 중심 복귀. 수직 반동 위주.',
    pattern: [
      [0.00, 0.045], [0.00, 0.095], [0.00, 0.152], [-0.01, 0.215], [-0.02, 0.280],
      [-0.03, 0.344], [-0.04, 0.404], [-0.04, 0.458], [-0.04, 0.506], [-0.04, 0.548],
      [-0.03, 0.584], [-0.02, 0.614], [0.00, 0.640], [0.02, 0.662], [0.03, 0.682],
      [0.03, 0.700],  [0.02, 0.716], [0.01, 0.730], [0.00, 0.743], [-0.01, 0.754],
    ],
  },
  {
    ...
    pattern: [
      [0.00, 0.062], [0.05, 0.134], [0.10, 0.224], [0.15, 0.328], [0.19, 0.442],
      [0.17, 0.535], [0.13, 0.614], [0.08, 0.678], [0.02, 0.724], [-0.05, 0.760],
      [-0.12, 0.786], [-0.16, 0.806], [-0.13, 0.822], [-0.07, 0.836], [0.00, 0.848],
      [0.07, 0.860],  [0.11, 0.870], [0.09, 0.879], [0.06, 0.887],  [0.03, 0.894],
    ],
  },
  {
    ...
    pattern: [
      [0.00, 0.040], [0.01, 0.088], [0.02, 0.146], [0.03, 0.210], [0.03, 0.278],
      [0.02, 0.346], [0.01, 0.410], [0.00, 0.468], [-0.01, 0.520], [-0.03, 0.564],
      [-0.04, 0.600], [-0.03, 0.630], [-0.01, 0.654], [0.01, 0.674], [0.02, 0.692],
      [0.03, 0.708],  [0.03, 0.722], [0.02, 0.735], [0.01, 0.747],  [0.00, 0.758],
    ],
  },
  {
    ...
    desc: '고속+고데미지+강반동 삼박자. 연사 시 초반 강한 우편향 제어가 핵심.',
    pattern: [
      [0.00, 0.072], [0.06, 0.155], [0.13, 0.258], [0.20, 0.374], [0.24, 0.500],
      [0.22, 0.592], [0.17, 0.664], [0.11, 0.722], [0.03, 0.764], [-0.06, 0.794],
      [-0.14, 0.818], [-0.19, 0.836], [-0.15, 0.852], [-0.08, 0.864], [0.01, 0.874],
      [0.08, 0.883],  [0.12, 0.891], [0.10, 0.898], [0.07, 0.904],  [0.04, 0.910],
    ],
  },
  {
    id: 'FAMAS', name: 'FAMAS', cal: '5.56mm', rpm: 900, dmg: 40, rounds: 25,
    color: '#A855F7',
    pullDown: '매우 많이 (수직)', pullH: '거의 없음',
    desc: '전 AR 중 가장 수직적인 반동. 수평 제어 불필요, 아래 당김 집중.',
    pattern: [
      [0.00, 0.052], [0.00, 0.108], [0.01, 0.170], [0.01, 0.236], [0.00, 0.304],
      [-0.01, 0.372], [-0.01, 0.436], [0.00, 0.496], [0.01, 0.552], [0.01, 0.602],
      [0.00, 0.646], [-0.01, 0.684], [-0.01, 0.718], [0.00, 0.748], [0.01, 0.774],
      [0.01, 0.797],  [0.00, 0.818], [-0.01, 0.836], [-0.01, 0.852], [0.00, 0.866],
    ],
  },
  {
    id: 'G36C', name: 'G36C', cal: '5.56mm', rpm: 580, dmg: 43, rounds: 30,
    color: '#84CC16',
    pullDown: '보통', pullH: '우→좌 (약간)',
    desc: '느린 발사속도와 적당한 반동. SCAR-L과 유사하며 초반 우편향이 약간 있음.',
    pattern: [
      [0.00, 0.038], [0.02, 0.082], [0.04, 0.138], [0.06, 0.202], [0.07, 0.270],
      [0.07, 0.338], [0.05, 0.400], [0.03, 0.456], [0.01, 0.506], [-0.02, 0.548],
      [-0.05, 0.584], [-0.05, 0.614], [-0.03, 0.638], [0.00, 0.658], [0.03, 0.676],
      [0.05, 0.692],  [0.05, 0.706], [0.03, 0.718], [0.01, 0.729], [-0.01, 0.739],
    ],
  },
  {
    ...
    pattern: [
      [0.00, 0.066], [0.04, 0.142], [0.10, 0.234], [0.16, 0.338], [0.19, 0.450],
      [0.17, 0.548], [0.13, 0.628], [0.08, 0.692], [0.02, 0.738], [-0.05, 0.772],
      [-0.11, 0.798], [-0.15, 0.818], [-0.12, 0.834], [-0.06, 0.848], [-0.01, 0.858],
      [0.05, 0.868],  [0.09, 0.876], [0.08, 0.883], [0.05, 0.889],  [0.02, 0.895],
    ],
  },
  {
    id: 'K2', name: 'K2', cal: '5.56mm', rpm: 720, dmg: 41, rounds: 30,
    color: '#22D3EE',
    pullDown: '많이', pullH: '우→좌 (약간)',
    desc: 'M416과 매우 유사한 패턴. 약간 더 빠른 RPM. 실용적인 AR.',
    pattern: [
      [0.00, 0.042], [0.02, 0.090], [0.04, 0.152], [0.07, 0.224], [0.08, 0.300],
      [0.07, 0.372], [0.05, 0.440], [0.02, 0.500], [-0.01, 0.552], [-0.05, 0.596],
      [-0.07, 0.632], [-0.06, 0.662], [-0.03, 0.686], [0.00, 0.706], [0.03, 0.724],
      [0.06, 0.740],  [0.06, 0.754], [0.04, 0.767], [0.01, 0.778],  [-0.01, 0.788],
    ],
  },
  {
    id: 'M16A4', name: 'M16A4', cal: '5.56mm', rpm: 800, dmg: 41, rounds: 30,
    color: '#64748B',
    pullDown: '많이', pullH: '우→좌 (보통)',
    desc: '800RPM 연사 유지 기준. M416보다 수평 진폭이 약간 더 크다.',
    pattern: [
      [0.00, 0.046], [0.03, 0.100], [0.07, 0.170], [0.10, 0.250], [0.11, 0.334],
      [0.09, 0.412], [0.06, 0.482], [0.02, 0.540], [-0.03, 0.588], [-0.08, 0.626],
      [-0.10, 0.656], [-0.09, 0.680], [-0.05, 0.700], [0.00, 0.718], [0.05, 0.734],
      [0.09, 0.748],  [0.08, 0.760], [0.05, 0.771], [0.02, 0.780],  [-0.02, 0.788],
    ],
  },
  {
    ...
    pattern: [
      [0.00, 0.040], [0.02, 0.090], [0.04, 0.158], [0.07, 0.238], [0.09, 0.322],
      [0.08, 0.402], [0.06, 0.472], [0.04, 0.536], [0.01, 0.588], [-0.03, 0.630],
      [-0.07, 0.660], [-0.09, 0.682], [-0.07, 0.700], [-0.04, 0.716], [-0.01, 0.730],
      [0.03, 0.744],  [0.06, 0.756], [0.07, 0.768], [0.05, 0.778],  [0.03, 0.787],
    ],
  },
  {
    id: 'MK47', name: 'MK47 Mutant', cal: '7.62mm', rpm: 800, dmg: 49, rounds: 20,
    color: '#D97706',
    pullDown: '많이', pullH: '우→좌 (보통)',
    desc: '800RPM 연사 유지 기준. 7.62mm 고데미지에 비해 반동이 관리 가능한 수준.',
    pattern: [
      [0.00, 0.056], [0.04, 0.118], [0.08, 0.196], [0.12, 0.286], [0.15, 0.384],
      [0.14, 0.472], [0.11, 0.548], [0.07, 0.610], [0.01, 0.658], [-0.04, 0.696],
      [-0.09, 0.726], [-0.12, 0.750], [-0.09, 0.768], [-0.04, 0.784], [0.01, 0.796],
      [0.07, 0.808],  [0.10, 0.818], [0.08, 0.827], [0.05, 0.834],  [0.02, 0.840],
    ],
  },
  {
    ...
    color: '#10B981',
    pullDown: '많이', pullH: '우→좌 (약간)',
    desc: 'M416과 매우 유사. 초반 수직 반동이 살짝 더 강하고 수평 진폭은 비슷.',
    pattern: [
      [0.00, 0.042], [0.02, 0.092], [0.04, 0.154], [0.06, 0.224], [0.07, 0.296],
      [0.05, 0.364], [0.02, 0.430], [-0.01, 0.488], [-0.05, 0.538], [-0.08, 0.578],
      [-0.07, 0.612], [-0.04, 0.638], [0.00, 0.660], [0.04, 0.678], [0.07, 0.694],
      [0.07, 0.708],  [0.05, 0.722], [0.02, 0.734], [-0.01, 0.745], [-0.02, 0.754],
    ],
  },
  {
    ...
    pattern: [
      [0.00, 0.036], [0.01, 0.078], [0.02, 0.130], [0.04, 0.190], [0.05, 0.252],
      [0.05, 0.318], [0.03, 0.380], [0.01, 0.438], [-0.02, 0.488], [-0.05, 0.530],
      [-0.06, 0.564], [-0.05, 0.592], [-0.02, 0.614], [0.01, 0.632], [0.04, 0.648],
      [0.05, 0.662],  [0.05, 0.674], [0.04, 0.685], [0.02, 0.695],  [0.00, 0.704],
    ],
  },
  // ─── SMG ────────────────────────────────────────────────────────────────
  {
