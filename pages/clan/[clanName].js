  ...
  const fetchClanData = async () => {
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          `클랜 데이터를 가져올 수 없습니다 (${response.status})`
        );
      }
    ...
    return (
      <Layout>
        <div
          ...
          style={{ paddingTop: '0', marginTop: '-5rem' }}
        >
              ...
              <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center">
                <div className="mb-4 lg:mb-0">
                  ...
                  <div className="flex items-center gap-4 text-gray-400">
                    <span className="bg-gray-700 px-3 py-1 rounded text-lg font-mono">
                      {clan.tag}
                    </span>
                ...
                {clan.playStyle && (
                  <div className="text-right">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="text-xs text-gray-400">
                        지배율: {clan.playStyle.dominance}% | 다양성:{' '}
                        {clan.playStyle.variety}
                      </div>
                    </div>
                  </div>
                )}
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <StatCard
                      ...
                      title="승률"
                      value={
                        stats?.winRate ? `${Math.round(stats.winRate)}%` : 'N/A'
                      }
                      subtitle="전체 게임 기준"
                      ...
                      <div>
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span>
                              {clan.updatedAt
                                ? new Date(clan.updatedAt).toLocaleDateString(
                                    'ko-KR'
                                  )
                                : 'N/A'}
                            </span>
                              ...
                              content={
                                <div className="text-left">
                                  ...
                                  <div className="text-sm mb-2">
                                    PUBG 공식 MMR과는 다른 PK.GG 독자적인 계산법
                                  </div>
                                  <div className="text-xs space-y-1">
                                    <div>• 킬/데미지/생존시간 종합 평가</div>
                                    <div>• 높을수록 실력이 우수함을 의미</div>
                                    <div>
                                      • PUBG 공식 MMR과는 산출 기준이 다름
                                    </div>
                                  </div>
                                </div>
                              }
                        ...
                        {members
                          ...
                          .map((member, index) => (
                            ...
                            >
                              ...
                              <td className="px-4 py-3">
                                {member.stats?.kdRatio
                                  ? Number(member.stats.kdRatio).toFixed(1)
                                  : 'N/A'}
                              </td>
                              <td className="px-4 py-3">
                                {member.stats?.winRate
                                  ? `${Math.round(member.stats.winRate)}%`
                                  : 'N/A'}
                              </td>
