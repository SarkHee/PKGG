...
const CHANGELOG = [
  {
    date: '2026.08',
    items: [
      { icon: '🏆', text: '클랜 분석 — 일반전/경쟁전 구분 추가 (티어, 평균딜, 평균킬, 승률, Top10, 생존시간)' },
      { icon: '🎯', text: '타겟프랙티스 — 60초 표적 사격 미니게임 추가, 실시간 리더보드/전체화면 지원' },
      { icon: '🎬', text: '2D 매치 리플레이 — 비행기 탑승부터 착지, 교전까지 재생 가능, 배속/타임라인 조작 지원' },
      { icon: '🔒', text: '계정 검색 비활성화 — 마이페이지에서 내 전적 검색 차단 기능 추가' },
      { icon: '🤖', text: '디스코드 봇 — /이번주무기티어, /스쿼드예약 명령어 추가' },
      { icon: '🐛', text: '클랜 랭킹 — 멤버 없는 유령 클랜 노출 문제 수정' },
      { icon: '🔫', text: '무기 메타 — 윈체스터/Win94 오집계 문제 수정' },
      { icon: '📋', text: '경기 내역 — 이벤트/사용자 지정 게임 누락 문제 수정' },
      { icon: '🌐', text: '다국어 지원 확대 — 포럼, 파티, 세팅공유, 문의, 공지사항 등' },
    ],
  },
  {
    date: '2026.04',
