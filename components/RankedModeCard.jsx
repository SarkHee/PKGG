    ...
    <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">
      <div className="text-center mb-3">
        ...
        <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">
          ...
          {mode.currentTier && mode.subTier && <span> ({mode.subTier}단계)</span>}
        </div>
      </div>
      ...
      <div className="space-y-2 text-sm mb-4">
        <div className="flex justify-between">
          ...
          <span className="font-medium text-yellow-600 dark:text-yellow-400">
            {typeof mode.currentRankPoint === 'number' ? mode.currentRankPoint.toLocaleString() : '0'}
          </span>
        </div>
        <div className="flex justify-between">
      ...
      <div className="space-y-2 text-sm mb-4 pt-3 border-t border-gray-200 dark:border-gray-600">
        ...
        <div className="flex justify-between">
          ...
          <span className="font-medium text-gray-600 dark:text-gray-400">
            {typeof mode.deaths === 'number' ? mode.deaths.toLocaleString() : '0'}
          </span>
        </div>
        <div className="flex justify-between">
          <span className="text-gray-600 dark:text-gray-400">어시스트</span>
          <span className="font-medium text-blue-600 dark:text-blue-400">
            {typeof mode.assists === 'number' ? mode.assists.toLocaleString() : '0'}
          </span>
        </div>
        <div className="flex justify-between">
        ...
        <div className="flex justify-between">
          ...
          <span className="font-medium text-orange-600 dark:text-orange-400">
            {typeof mode.damageDealt === 'number' ? mode.damageDealt.toLocaleString() : '0'}
          </span>
        </div>
        <div className="flex justify-between">
          <span className="text-gray-600 dark:text-gray-400">플레이한 라운드</span>
          <span className="font-medium text-gray-900 dark:text-gray-100">
            {typeof mode.roundsPlayed === 'number' ? mode.roundsPlayed.toLocaleString() : '0'}
          </span>
        </div>
        <div className="flex justify-between">
          <span className="text-gray-600 dark:text-gray-400">Top 10 비율</span>
          <span className="font-medium text-yellow-600 dark:text-yellow-400">
            {typeof mode.top10Ratio === 'number' ? (mode.top10Ratio * 100).toFixed(1) + '%' : '0.0%'}
          </span>
        </div>
      </div>
            {/* 추가 통계 */}
      <div className="space-y-2 text-sm pt-3 border-t border-gray-200 dark:border-gray-600">
        ...
        <div className="flex justify-between">
          ...
          <span className="font-medium text-gray-900 dark:text-gray-100">
            {typeof mode.bestRankPoint === 'number' ? mode.bestRankPoint.toLocaleString() : '0'}
          </span>
        </div>
        <div className="flex justify-between">
          <span className="text-gray-600 dark:text-gray-400">한 라운드 최다 킬</span>
          <span className="font-medium text-purple-600 dark:text-purple-400">
            {typeof mode.roundMostKills === 'number' ? mode.roundMostKills : '0'}
          </span>
        </div>
        <div className="flex justify-between">
        ...
        <div className="flex justify-between">
          ...
          <span className="font-medium text-blue-600 dark:text-blue-400">
            {typeof mode.longestKill === 'number' ? mode.longestKill.toFixed(0) : '0'}m
          </span>
        </div>
        <div className="flex justify-between">
