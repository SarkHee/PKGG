...
export default function SynergyHeatmap({ matches, myNickname, clanMembers = [], playerClan }) {
  ...
  return (
    <div style={{ margin: '0' }}>
      <div style={{ fontWeight: 700, fontSize: 16, marginBottom: 16, color: '#2563eb' }}>
        베스트 시너지 클랜원
      </div>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', flex: 1 }}>
                ...
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', marginBottom: 4 }}>
                    <span style={{ fontWeight: 600, fontSize: 16, color: '#222', marginRight: 8 }}>
                      {user.name}
                    </span>
                    {index < 3 && (
                      <span style={{
              ...
              <div style={{ display: 'flex', gap: 24, alignItems: 'center' }}>
                <div style={{ textAlign: 'center' }}>
                  <div style={{ fontSize: 12, color: '#888', marginBottom: 2 }}>승률</div>
                  <div style={{ 
                    fontSize: 16, 
                    fontWeight: 'bold',
                ...
                <div style={{ textAlign: 'center' }}>
                  <div style={{ fontSize: 12, color: '#888', marginBottom: 2 }}>평균 딜량</div>
                ...
                <div style={{ textAlign: 'center' }}>
                  <div style={{ fontSize: 12, color: '#888', marginBottom: 2 }}>평균 등수</div>
                  <div style={{ fontSize: 16, fontWeight: 'bold', color: '#222' }}>
